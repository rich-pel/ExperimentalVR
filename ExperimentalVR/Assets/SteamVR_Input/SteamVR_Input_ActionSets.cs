...
namespace Valve.VR
{
    ...
    public partial class SteamVR_Actions
    {
        ...
        private static SteamVR_Input_ActionSet_testOwnInput p_testOwnInput;
        ...
        public static SteamVR_Input_ActionSet_testOwnInput testOwnInput
        {
            get
            {
                return SteamVR_Actions.p_testOwnInput.GetCopy<SteamVR_Input_ActionSet_testOwnInput>();
            }
        }
        ...
        private static void StartPreInitActionSets()
        {
            ...
            SteamVR_Actions.p_testOwnInput = ((SteamVR_Input_ActionSet_testOwnInput)(SteamVR_ActionSet.Create<SteamVR_Input_ActionSet_testOwnInput>("/actions/testOwnInput")));
            Valve.VR.SteamVR_Input.actionSets = new Valve.VR.SteamVR_ActionSet[] {
                    SteamVR_Actions._default,
                    SteamVR_Actions.platformer,
                    SteamVR_Actions.buggy,
                    SteamVR_Actions.mixedreality,
                    SteamVR_Actions.testOwnInput};
        }
    }
}
